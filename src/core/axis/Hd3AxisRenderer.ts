...
export interface Hd3AxisRendererOptions {
  name: string;
  axis: Hd3Axis;
  scaleType?: ScaleType;
  range?: [number, number];
 ...
 */
export abstract class Hd3AxisRenderer implements RenderableI {
  public name: string;
  protected axis: Hd3Axis;
  ...
  constructor(options: Hd3AxisRendererOptions) {
